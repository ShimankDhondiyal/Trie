 ...
 *
 */
class Indexes {		//object made up of wordIndex, startIndex, and endIndex
	 ...
	 */
	short startIndex;	//low value integer
	
	/**
	 * End index of substring in word.
	 */
	short endIndex;		//low value integer
...
public class TrieNode {
	 ...
	 */
	Indexes substr;		//substring treated as object ex: (2,1,2)
	 ...
	 */
	TrieNode sibling;		//can act as second child node
	//ex: amazing, amazon:	i and o are sibling nodes
	/**
